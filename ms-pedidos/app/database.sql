...
INSERT INTO pedidos (mesa_id, fecha, hora, subtotal, total, estado, created_at, updated_at)
VALUES (1, '2026-06-10', '20:00:00', 36000, 36000, 'pendiente', NOW(), NOW());

INSERT INTO detalles_pedidos (pedido_id, producto_id, nombre_producto, cantidad, precio_unitario, subtotal, created_at, updated_at)
VALUES
